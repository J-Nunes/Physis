...
public:
	...
	bool CleanUp();
	void CreateCircle(unsigned int center_x, unsigned int center_y, unsigned int radius);
	void CreateBox(unsigned int width, unsigned int height);
	void CreateChain(p2DynArray<int> points);
